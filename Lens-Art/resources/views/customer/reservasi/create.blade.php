...
@section('title', 'Tambah Reservasi Customer - Studio LensArt')

@section('content')
<section class="reservasi-form-section">
    <div class="reservasi-form-header">
        <div>
            <h1 class="section-title">Tambah Reservasi</h1>
            <p class="section-desc">
                Isi data reservasi untuk membuat jadwal pemotretan di Studio LensArt.
            </p>
        </div>

        <a href="{{ route('customer.reservasi.index') }}" class="btn-secondary">
            Kembali
        </a>
    </div>
    ...
    <form action="{{ route('customer.reservasi.store') }}" method="POST" class="reservasi-form-card">
        @csrf
        ...
        <div class="form-section-title">
            ...
            <p>Pilih paket foto. Harga akan mengikuti paket yang dipilih.</p>
        </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    readonly
                >
                <small class="form-help">Harga otomatis mengikuti paket foto yang dipilih.</small>
            </div>
        ...
        <div class="form-section-title">
            ...
            <p>Pilih tanggal dan slot jam reservasi.</p>
        </div>
